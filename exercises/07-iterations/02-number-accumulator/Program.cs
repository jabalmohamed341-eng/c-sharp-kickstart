...
if (count > 0)
{
    Console.Write("Final Statistics:");
    Console.Write("================");
    Console.Write($"Total numbers entered: {count}");
    Console.Write($"Sum: {sum}");
    Console.Write($"Average: {sum / count:F1}");
    Console.Write($"Highest number: {highest}");
    Console.Write($"Lowest number: {lowest}");
}
else
{
