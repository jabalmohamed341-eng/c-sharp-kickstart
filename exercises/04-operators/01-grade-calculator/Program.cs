...
Console.WriteLine("Letter Grade: " + "TODO");
Console.WriteLine("Passed Course: " + "TODO");
Console.WriteLine("Honor Roll (90%+): " + "TODO");
Console.WriteLine("Needs Improvement (<70%): " + "TODO");